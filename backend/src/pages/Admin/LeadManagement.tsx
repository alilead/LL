...
import { leadsAPI, usersAPI, tagsAPI } from '@/services/api';
...
export function LeadManagement() {
  ...
  if (isLeadsLoading || isUsersLoading || isTagsLoading) {
          ...
          {leads.map((lead: Lead) => (
            ...
            >
              <div>
                ...
                {lead.assigned_to && (
                  <p className="text-sm">
                    Assigned to: {lead.assigned_to.first_name} {lead.assigned_to.last_name}
                  </p>
                )}
              </div>
              <div>
                <Select
                  value={lead.assigned_to_id?.toString() || ''}
                  onValueChange={(value) => {
