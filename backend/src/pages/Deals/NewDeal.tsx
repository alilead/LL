      ...
      <div className="max-w-5xl mx-auto py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl font-bold text-gray-800">New Deal</h1>
          </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 gap-6 bg-white rounded-xl shadow-sm border p-6">
              <div className="col-span-1 border-b pb-4 mb-2">
                <h2 className="text-xl font-semibold text-gray-800">Deal Information</h2>
                <p className="text-sm text-gray-500 mt-1">Enter the basic information about this deal</p>
              </div>
            ...
            <div className="grid grid-cols-1 gap-6 bg-white rounded-xl shadow-sm border p-6">
              <div className="col-span-1 border-b pb-4 mb-2">
                ...
                <p className="text-sm text-gray-500 mt-1">Set additional properties for this deal</p>
              </div>
            ...
            <div className="flex justify-end gap-4 bg-white rounded-xl shadow-sm border p-4">
              <Button
                type="button"
                variant="outline"
                onClick={() => navigate('/deals')}
