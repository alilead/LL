...
class Settings(BaseSettings):
    ...
    EMAILS_FROM_EMAIL: str = Field(default="onboarding@resend.dev", description="Default from email (use Resend default domain 'onboarding@resend.dev' or your verified domain)")
