...
// Credits
const CreditsPage = lazy(() => import('./pages/Credits').then(module => ({ default: module.CreditsPage })));

// Organization
const OrganizationPage = lazy(() => import('./pages/OrganizationPage').then(module => ({ default: module.default })));

// Team Management
const TeamManagement = lazy(() => import('./pages/TeamManagement').then(module => ({ default: module.default })));
const AcceptInvitation = lazy(() => import('./pages/AcceptInvitation').then(module => ({ default: module.default })));
