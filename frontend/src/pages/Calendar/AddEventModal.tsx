...
export function AddEventModal({ isOpen, onClose, leadId }: AddEventModalProps) {
  const { user } = useAuth();
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            id="color"
                            {...register('color')}
                            className="mt-1 block w-full h-9 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                          />
                        </div>
                      </div>
